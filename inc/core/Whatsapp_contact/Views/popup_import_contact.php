    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="<?php _ec($config['icon']) ?>" style="color: <?php _ec($config['color']) ?>;"></i> <?php _ec("Import contact") ?>
                </h5>
                        ...
                        <div class="tab-pane fade show active p-50" id="import_csv">
                            <div class="mb-3">
                                <a href="<?php _e(get_module_url("download_example_upload_csv")) ?>" class="btn btn-secondary btn-block w-100">
                                    <i class="fas fa-download"></i> <?php _e("Example template") ?> CSV
                                </a>
                            </div>
                            <!-- <div class="mb-3">
                                <a href="<?php _e(get_module_url("download_example_upload_excel")) ?>"
                                   class="btn btn-secondary btn-block w-100">
                                    <i class="fas fa-download"></i> <?php _e("Example template") ?> EXCEL
                                </a>
                            </div> -->
                            <!-- <div class="mb-3">
                                <a href="https://docs.google.com/spreadsheets/d/1ayVErNO-KdshixoJzR_r7jvDp9DNTJzi/edit?usp=sharing&ouid=114027151131555959366&rtpof=true&sd=true"
                                   class="btn btn-secondary btn-block w-100" target="_blank">
                                    <i class="fas fa-file-spreadsheet"></i> <?php _e("Template in Google Sheets") ?>
                                </a>
                            </div> -->
