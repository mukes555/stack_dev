	...
	<table style="width: 1366px; border: 1px solid #000000; font-family: Tahoma; margin: auto;">
		...
		<?php if (count($daterange) == 2) : ?>
			<tr>
				...
				<th colspan="2" style="color: #000; padding: 5px; border: 1px solid #000000; text-align: left; mso-number-format:'Short Date'"><?php _ec(date_show($daterange[0])) ?></th>
				...
				<th colspan="2" style="color: #000; padding: 5px; border: 1px solid #000000; text-align: left; mso-number-format:'Short Date'"><?php _ec(date_show($daterange[1])) ?></th>
			</tr>
		<?php endif ?>
		<tr>
